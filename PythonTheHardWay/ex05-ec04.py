...
weight_in_kilos = my_weight * 0.453592
height_in_meters = my_height * 0.0254

print "Let's talk about %s." % my_name
print "He's %.2f meters tall." % height_in_meters						#Needed %f, not %d
print "He weights %.2f kilograms." % weight_in_kilos
...
print "If I add %d, %.2f, and %.2f I get %.2f, a number that I might play tonight." % (
